...
const FormInventario = () => {
  ...
  const fetchData = async () => {
    ...
    if (form !== null) {
      ...
      document
        .getElementById(`email-in-err`)
        ?.classList.add("hidden");
      document
        .getElementById(`segmento-err`)
        ?.classList.add("hidden");
      if (
        !payload.nome ||
        !String(payload.email).match(
          /^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$/g
        ) ||
        !payload.area
      ) {
      ...
      {!state ? (
            ...
            <fieldset className='flex flex-col gap-1'>
              ...
              >
                ...
                <option value='Associação Comercial, Empresarial, Industrial, Setorial (Núcleos)'>
                  Associação Comercial, Empresarial, Industrial,
                  Setorial (Núcleos)
                </option>
                <option value='Associação Cultural, Desportiva, Social, Recreativa, Clubes'>
                  Associação Cultural, Desportiva, Social, Recreativa,
                  Clubes
                </option>
                ...
                <option value='Associação/Cooperativa de Produtores (rural, artesanato, turismo, etc.)'>
                  Associação/Cooperativa de Produtores (rural,
                  artesanato, turismo, etc.)
                </option>
                <option value='Casa de Espetáculos'>
                  Casa de Espetáculos
                </option>
                ...
                <option value='Empreendimento de Entretenimento e Lazer/Parque Aquático'>
                  Empreendimento de Entretenimento e Lazer/Parque
                  Aquático
                </option>
                ...
                <option value='Local de Eventos'>
                  Local de Eventos
                </option>
                <option value='Organizadora de Eventos'>
                  Organizadora de Eventos
                </option>
                <option value='Parque Temático'>
                  Parque Temático
                </option>
                ...
                <option value='Sistema S (SEBRAE, SENAI, SENAC, SESC, SEST/SENAT, SENAR, outros)'>
                  Sistema S (SEBRAE, SENAI, SENAC, SESC, SEST/SENAT,
                  SENAR, outros)
                </option>
        ...
        <div className='w-full'>
          <a
            ...
            href='assets/docs/Inventário Pato Branco_web.pdf'
            download
          >
